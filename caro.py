...
gamemode_buttons = []
# MAP
map_3x3_button_rect = pygame.Rect(X_MAP_BUTTON, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT)
map_5x5_button_rect = pygame.Rect(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN), Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT)
map_10x10_button_rect = pygame.Rect(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*2, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT)
map_15x15_button_rect = pygame.Rect(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*3, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT)
map_17x17_button_rect = pygame.Rect(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*4, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT)
#GAME MODE
...
def main():
	...
	while True:
		for event in pygame.event.get():
			...
			if game.running == False:
				...
				if event.type == pygame.MOUSEBUTTONDOWN:
					...
					if map_5x5_button_rect.collidepoint(event.pos) and game.ROWS != 5:
						# Xử lý sự kiện khi click vào nút 5x5
						game.ROWS = 5
						game.COLS = 5
						upadateConstant(game.ROWS, game.COLS)
						if game.gamemode == 'ai':
					...
					if map_10x10_button_rect.collidepoint(event.pos) and game.ROWS != 10:
						# Xử lý sự kiện khi click vào nút 10x10
						game.ROWS = 10
						game.COLS = 10
						upadateConstant(game.ROWS, game.COLS)
						if game.gamemode == 'ai':
					...
					if map_15x15_button_rect.collidepoint(event.pos) and game.ROWS != 15:
						# Xử lý sự kiện khi click vào nút 15x15
						game.ROWS = 15
						game.COLS = 15
						upadateConstant(game.ROWS, game.COLS)
						if game.gamemode == 'ai':
		...
		game.draw_text(WIDTH + (WIDTH_BG - WIDTH) // 2, 12, "MAP SETTINGS", WHITE, 36)
		if game.ROWS == 3:
			# Vẽ nút "3x3"
			game.draw_button(X_MAP_BUTTON, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "3x3", MAP_SELECTED_COLOR, WHITE, 26)
		else:
			# Vẽ nút "3x3"
			game.draw_button(X_MAP_BUTTON, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "3x3", GRAY, WHITE, 26)
		
		if game.ROWS == 5:
			# Vẽ nút "5x5"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN), Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "5x5", MAP_SELECTED_COLOR, WHITE, 26)
		else:
			# Vẽ nút "5x5"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN), Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "5x5", GRAY, WHITE, 26)
		
		if game.ROWS == 10:
			# Vẽ nút "10x10"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*2, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "10x10", MAP_SELECTED_COLOR, WHITE, 26)
		else:
			# Vẽ nút "10x10"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*2, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "10x10", GRAY, WHITE, 26)
		
		if game.ROWS == 15:
			# Vẽ nút "15x15"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*3, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "15x15", MAP_SELECTED_COLOR, WHITE, 26)
		else:
			# Vẽ nút "15x15"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*3, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "15x15", GRAY, WHITE, 26)
		
		if game.ROWS == 17:
			# Vẽ nút "17x17"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*4, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "17x17", MAP_SELECTED_COLOR, WHITE, 26)
		else:
			# Vẽ nút "17x17"
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*4, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "17x17", GRAY, WHITE, 26)
		...
		if map_3x3_button_rect.collidepoint(pygame.mouse.get_pos()):
			game.draw_button(X_MAP_BUTTON, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "3x3", MAP_HOVER_COLOR, WHITE, 26)
			# Thiết lập kiểu con trỏ chuột thành kiểu "hand"
			pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
		
		#5x5
		elif map_5x5_button_rect.collidepoint(pygame.mouse.get_pos()):
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN), Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "5x5", MAP_HOVER_COLOR, WHITE, 26)
			# Thiết lập kiểu con trỏ chuột thành kiểu "hand"
			pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
		
		#10x10
		elif map_10x10_button_rect.collidepoint(pygame.mouse.get_pos()):
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*2, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "10x10", MAP_HOVER_COLOR, WHITE, 26)
			# Thiết lập kiểu con trỏ chuột thành kiểu "hand"
			pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
		
		#15x15
		elif map_15x15_button_rect.collidepoint(pygame.mouse.get_pos()):
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*3, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "15x15", MAP_HOVER_COLOR, WHITE, 26)
			# Thiết lập kiểu con trỏ chuột thành kiểu "hand"
			pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
		
		#17x17
		elif map_17x17_button_rect.collidepoint(pygame.mouse.get_pos()):
			game.draw_button(X_MAP_BUTTON + (MAP_BUTTON_WIDTH + MAP_BUTTON_MARGIN)*4, Y_MAP_BUTTON, MAP_BUTTON_WIDTH, MAP_BUTTON_HEIGHT, "17x17", MAP_HOVER_COLOR, WHITE, 26)
			# Thiết lập kiểu con trỏ chuột thành kiểu "hand"
			pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
